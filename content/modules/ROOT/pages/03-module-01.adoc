...
+
TIP: One in the Storage Cluster overview you can look at the specific storage type provided by clicking the specific types of storage as highlighted with a number 2.
+
...
. The IBM Fusion Backup & Restore Service is not being installed as illustrated below.
+
...
This completes this part of the lab. The IBM Fusion Backup & Restore functionality will be configured and used in the optional **Module 5**.
