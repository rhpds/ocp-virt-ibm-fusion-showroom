...
At this point you will see a dialog box: "Migrate VirtualMachine to a different Node". Select "Specific Node" and then choose a new node for the target migration. The click "Migrate Virtual Machine"
