...
* **Module 3**: Workload migration (20 minutes)
* **Module 4**: IBM Fusion Access for SAN (20 minutes)
* **Module 5**: IBM Fusion Backup & Restore (if time permits)

=== Abbreviated workshop (60 minutes)

* **Module 1**: Exploring the environment (15 minutes)
* **Module 2**: VM lifecycle management (15 minutes)
* **Module 3**: Workload migration (15 minutes, core exercises only)
* **Module 4**: Workload migration (15 minutes, core exercises only)
